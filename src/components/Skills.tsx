...
export function Skills() {
    return (
        <div className="w-full relative h-auto md:h-auto min-h-screen overflow-hidden flex flex-col m-auto py-20 justify-center bg-cover bg-center bg-no-repeat" style={{backgroundImage: `url(${background})`, }}>
            ...
            <div className="grid-cols-2 md:grid-cols-3 grid gap-y-10 place-items-center w-auto text-center mx-auto z-10">
